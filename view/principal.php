...
<header class="w3-container w3-padding-32 w3-center " id="home">
 <h1>
 <img src="../public/images/logo-2.png" alt="Logo" class="w3-image" width="5%">
 </br>
 </h1>
 <a class="w3-text-cyan" style="font-size:large; font-family:Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif">ENLATADOS JUAREZ</a>
 <br>
...
<div>
<form action="" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%; padding-left:400px">
 ...
 <div class="w3-row w3-section">
 <div class="w3-center" >
 <button name="btnAtualizar" class="w3-button w3-block w3-margin w3-blue w3-cell w3-round-large" style="width: 20%; height:50px">Atualizar</button>
 </div>
 </div>
 </form>
 </div>
...
<form action="" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%; padding-left:400px">
 ...
 <div class="w3-row w3-section">
 <div class="w3-center" >
 <button name="btnAddFormacao" class="w3-button w3-block w3-blue w3-cell w3-round-large" style="width:20%; height:50px"> Adicionar +</button>
 </div>
 </div>
 </form>
 </div>
 ...
 <thead>
 <tr class="w3-center w3-blue" style="padding-bottom: 50px;">
...
<form action="" method="post" class=" w3-row w3-light-grey w3-text-blue w3-margin" style="width:70%; padding-left:400px">
 ...
 <div class="w3-rest">
 <input class="w3-input w3-border w3-round-large" name="txtDescFA" type="text" placeholder="Descrição: Ex.: Curso de Inglês - Inglês City">
 </div>
 </div>
 ...
 <div class="w3-padding-128 w3-content w3-text-grey" id="eProfissional">
     <br><br>
 <h2 class="w3-text-cyan">Experiência Profissional</h2> </div>
...
<button name="btnAddEP" class="w3-button w3-block w3-blue w3-cell w3-round-large" style="width:20%; height:50px"> Adicionar +</button>
